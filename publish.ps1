...
if ($isWindows) {
  ...
  7z a Ambermoon.net-Windows.zip "./Ambermoon.net/Ambermoon.net.exe" "./AmbermoonPatcher/bin/Release/net7.0/win-x64/publish/AmbermoonPatcher.exe" "./Ambermoon.net/x64/api-ms-win-core-winrt-l1-1-0.dll" "./Package/*" -mx9
  ...
  7z a Ambermoon.net-Windows32Bit.zip "./Ambermoon.net/Ambermoon.net.exe" "./AmbermoonPatcher/bin/Release/net7.0/win-x86/publish/AmbermoonPatcher.exe" "./Ambermoon.net/x86/api-ms-win-core-winrt-l1-1-0.dll" "./Package/*" -mx9
} elseif ($isLinux) {
  ...
  Start-Process -FilePath "./Ambermoon.ConcatFiles/bin/Release/net7.0/linux-x64/publish/Ambermoon.ConcatFiles" -Wait -WorkingDirectory . -ArgumentList 'versions','"./versions.dat"','diffs','diffs.dat','"./Ambermoon.net/bin/Release/net7.0/linux-x64/publish/Ambermoon.net"'
  7z a Ambermoon.net-Linux.tar "./Ambermoon.net/bin/Release/net7.0/linux-x64/publish/Ambermoon.net" "./AmbermoonPatcher/bin/Release/net7.0/linux-x64/publish/AmbermoonPatcher" "./Package/*"
  ...
  cp "./Ambermoon.net/bin/Release/net7.0/osx-x64/publish/Ambermoon.net" ./bundle/Ambermoon.net/Ambermoon.net.app/Contents/MacOS/
  #cp "./AmbermoonPatcher/bin/Release/net7.0/osx-x64/publish/AmbermoonPatcher" ./bundle/Ambermoon.net/Ambermoon.net.app/Contents/MacOS/
  cp "./versions.dat" ./bundle/Ambermoon.net/Ambermoon.net.app/Contents/Resources/
  cp "./diffs.dat" ./bundle/Ambermoon.net/Ambermoon.net.app/Contents/Resources/
  ...
  cp "./Ambermoon.net/bin/Release/net7.0/osx-arm64/publish/Ambermoon.net" ./bundle-arm/Ambermoon.net/Ambermoon.net.app/Contents/MacOS/
  #cp "./AmbermoonPatcher/bin/Release/net7.0/osx-arm64/publish/AmbermoonPatcher" ./bundle-arm/Ambermoon.net/Ambermoon.net.app/Contents/MacOS/ 
